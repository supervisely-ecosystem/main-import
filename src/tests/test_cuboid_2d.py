...
# # from supervisely import Cuboid2d, Cuboid2dTemplate, Node
# from supervisely.geometry.cuboid_2d import CUBOID2D_VERTICES_NAMES

# obj_cls = sly.ObjClass("cuboid", sly.Cuboid2d)

# nodes = []
# for label in CUBOID2D_VERTICES_NAMES:
#     nodes.append(sly.Node(label=label, row=0, col=0))
# geom = sly.Cuboid2d(nodes)
# label = sly.Label(geom, obj_cls)
